...
\newblock Repository preprint snapshot. Current public repository identity for that line: \url{https://github.com/kei-saito-research/hidden-state-interface-reuse} (accessed 2026-03-05).
...
\newblock Repository preprint snapshot. Current public repository identity for that line: \url{https://github.com/kei-saito-research/nrr-patterns} (accessed 2026-03-07).
