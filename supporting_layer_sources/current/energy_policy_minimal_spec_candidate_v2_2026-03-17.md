# Energy Policy Minimal Spec Candidate v2
...
- Depends on:
  - `energy_policy_minimal_spec_candidate_v1_2026-03-17.md`
...
- before pilot design, freeze provider / family / metric selection in one separate artifact
- then define a fixed paired comparison for `baseline vs Energy policy` under those selected conditions
