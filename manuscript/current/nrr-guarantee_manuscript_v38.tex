...
paper must fill a single bounded reporting surface with the following fields:
...
Taken together, these supported, supporting, and boundary surfaces define a
bounded progression rather than a universal recipe. At the earliest boundary, the
...
carried first-step side-topic supporting surface stops being safe to extend.
