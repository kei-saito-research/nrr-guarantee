...
\begin{enumerate}
\item decide whether any later-horizon material can enter only as failure-boundary
reporting rather than as another supported claim unit
...
layer boundaries, and now adds bounded claim units for the early ambiguity-turn
surface, the downstream preacceptance-burden surface, and the repaired
first-step side-topic/quarantine surface while reserving broader downstream
closure for later, explicitly bounded revisions.
