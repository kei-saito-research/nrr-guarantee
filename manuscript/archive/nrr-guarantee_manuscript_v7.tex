...
\begin{enumerate}
\item prepare the current manuscript package for independent Codex and Claude
external review
...
policy vocabulary and dynamics motifs inherited from the supporting layers in
more review-readable prose.
