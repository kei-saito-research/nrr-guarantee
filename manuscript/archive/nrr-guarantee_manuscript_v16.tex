...
its operating language and does not redesign it locally~\cite{saito2026policy}.
...
\textit{Quarantine Leak}~\cite{saito2026dynamics}.
...
failure boundaries~\cite{saito2026policyverification,saito2026guaranteeschema}.
...
family-universal, or long-horizon overreach~\cite{saito2026guaranteeschema}.
...
\begin{itemize}
\item Program design:
  \texttt{energy\_to\_guarantee\_program\_design\_brief\_v1\_2026-03-17.md}~\cite{saito2026programbrief}
\item Policy:
  \texttt{policy\_minimal\_spec\_current\_v1\_2026-03-18.md}~\cite{saito2026policy}
\item Dynamics:
  \texttt{energy\_dynamics\_mechanism\_skeleton\_candidate\_v2\_2026-03-17.md}~\cite{saito2026dynamics}
  and
  \texttt{non\_evaluative\_principle\_dynamics\_closure\_note\_v1\_2026-03-19.md}
\item Policy-Verification:
  \texttt{policy\_verification\_pilot\_protocol\_current\_v1\_2026-03-18.md}~\cite{saito2026policyverification}
\item Guarantee schema:
  \texttt{energy\_guarantee\_claim\_schema\_candidate\_v2\_2026-03-17.md}~\cite{saito2026guaranteeschema}
\end{itemize}
...
\texttt{energy\_to\_policy\_handoff\_memo\_v1\_2026-03-18.md}~\cite{saito2026handoff}. That handoff memo
...
\bibitem{saito2026programbrief}
K.~Saito,
\newblock ``Energy-to-Guarantee Program Design Brief v1,''
\newblock Local supporting-layer memo, Mar. 17, 2026.

\bibitem{saito2026policy}
K.~Saito,
\newblock ``Policy Minimal Spec Current v1,''
\newblock Local supporting-layer memo, Mar. 18, 2026.

\bibitem{saito2026dynamics}
K.~Saito,
\newblock ``Energy Dynamics Mechanism Skeleton Candidate v2'' and
``Non-Evaluative Principle Dynamics Closure Note v1,''
\newblock Local supporting-layer memos, Mar. 17--19, 2026.

\bibitem{saito2026policyverification}
K.~Saito,
\newblock ``Policy-Verification Pilot Protocol Current v1,''
\newblock Local supporting-layer protocol memo, Mar. 18, 2026.

\bibitem{saito2026guaranteeschema}
K.~Saito,
\newblock ``Energy Guarantee Claim Schema Candidate v2,''
\newblock Local supporting-layer schema memo, Mar. 17, 2026.

\bibitem{saito2026handoff}
K.~Saito,
\newblock ``Energy-to-Policy Handoff Memo v1,''
\newblock Local supporting-layer handoff memo, Mar. 18, 2026.
