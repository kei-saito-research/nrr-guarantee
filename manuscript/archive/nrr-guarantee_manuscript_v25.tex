...
not establish a clean two-stage realization, the ablation realization still
lands mostly in \texttt{comparison-plus-followup}, Anthropic \texttt{D2}
remains a \texttt{1 / 10} collapse row, and the rerun does not establish
