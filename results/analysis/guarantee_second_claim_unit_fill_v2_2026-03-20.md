# Guarantee Second Claim Unit Fill v2
...
- Depends on:
  ...
  - `supporting_layer_sources/current/energy_policy_verification_downstream_boundary_readout_external_review_decision_memo_v1_2026-03-17.md`
