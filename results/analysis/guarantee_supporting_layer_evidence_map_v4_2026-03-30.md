# Guarantee Supporting Layer Evidence Map v4

## Purpose

This memo restates the current manuscript-facing source map in a way that keeps
historical support-layer texts, current upstream-authority notes, and audited
claim-evidence surfaces distinct.
...
- `guarantee_first_claim_unit_fill_v2_2026-03-20.md`
- `guarantee_phase2_downstream_acceptance_closure_import_note_v2_2026-03-30.md`
- `guarantee_second_claim_unit_fill_v5_2026-03-30.md`
...
| Claim unit and boundary discipline | `supporting_layer_sources/current/energy_guarantee_claim_schema_candidate_v2_2026-03-17.md` | Import the eight required claim-unit fields |
| First explicit claim-unit fill | `results/analysis/guarantee_first_claim_unit_fill_v2_2026-03-20.md` | Promote the first manuscript-facing bounded claim |
| Second downstream-acceptance fill | `results/analysis/guarantee_second_claim_unit_fill_v5_2026-03-30.md` | Promote the repaired mixed downstream-acceptance claim |
...
Do not describe `supporting_layer_sources/current/` by itself as the full proof
surface for the repaired second claim unit. The support bundle carries fixed
dependency texts and historical provenance. The manuscript-facing repaired
downstream-acceptance read is carried by the repo-local note surface together
with the imported reviewed readout surface listed above.
