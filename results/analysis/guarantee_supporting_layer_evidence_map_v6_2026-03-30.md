# Guarantee Supporting Layer Evidence Map v6

## Purpose

This memo restates the current manuscript-facing source map after the `v34`
...
- `guarantee_second_claim_unit_fill_v7_2026-03-30.md`
...
and carries the audited auxiliary repaired readout for the second claim unit:
...
| Second downstream-acceptance fill | `results/analysis/guarantee_second_claim_unit_fill_v7_2026-03-30.md` | Promote the mainline downstream-boundary claim on `baseline vs Energy policy`, with explicit shared burden-removal support and visible Gemini residual |
| Second downstream-acceptance closure note | `results/analysis/guarantee_phase2_downstream_acceptance_closure_import_note_v4_2026-03-30.md` | Keep the paper-level contract on `baseline vs Energy policy`, map the repaired fields explicitly, and demote `NRR vs Ablation` to auxiliary boundary evidence |
